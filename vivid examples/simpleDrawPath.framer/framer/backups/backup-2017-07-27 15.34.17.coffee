...
# <circle fill="#FFFFFF" stroke="#ED1E79" stroke-width="10" stroke-miterlimit="10" cx="215.7" cy="144.5" r="22.2"/>
# <circle fill="#FFFFFF" stroke="#ED1E79" stroke-width="10" stroke-miterlimit="10" cx="236.1" cy="918.8" r="22.2"/>
<path fill="none" stroke="#ED1E79" stroke-width="10" stroke-miterlimit="10" d="M-116.3,244.5"/>
</svg>'
